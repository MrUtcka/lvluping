...
public final class AssassinBarricadeClient {
    ...
    public static void onRenderLevelStage(RenderLevelStageEvent event) {
        ...
        ItemStack stack = new ItemStack(LvlupingItems.ASSASSIN_WALL_MODEL.get());
        ...
        for (Visual v : ACTIVE.values()) {
            ...
            pose.pushPose();
            pose.translate(v.x - camX, v.y - camY + 0.52, v.z - camZ);
